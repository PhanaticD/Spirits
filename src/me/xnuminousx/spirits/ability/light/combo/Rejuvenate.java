...
public class Rejuvenate extends LightAbility implements AddonAbility, ComboAbility {
	...
	public void spawnCircle() {
		...
		for (int i = 0; i < 6; i++) {
			...
			location2.add(x, 0, z);
			ParticleEffect.END_ROD.display(location2, 1);
			location2.subtract(x, 0, z);
			
			location3.add(x2, 0, z2);
			ParticleEffect.END_ROD.display(location3, 1);
			location3.subtract(x2, 0, z2);
		}
		
		ParticleEffect.ENCHANTMENT_TABLE.display(location, 10, radius / 2.0, 0.4F, radius / 2.0, 0);
	}
